...
class BlankFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // items.add(book_detail("wriiten by ishwar ","Data structur  ","https://firebasestorage.googleapis.com/v0/b/booky-bfee3.appspot.com/o/An_Introduction_to_Formal_Languages_and.pdf?alt=media&token=6c2046a1-3d2f-4744-a477-205aafaae001"))
